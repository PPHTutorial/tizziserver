...
const categories: [string, string, string, string | null, string[]][] = [
  ...
  ["beauty", "Beauty & Personal Care", "spray-can-sparkles", null, ["grandprice"]],
  ["sports-outdoors", "Sports & Outdoors", "dumbbell", null, ["grandprice"]],
  ["groceries", "Groceries", "basket-shopping", null, ["grandprice"]],
  ["baby-kids", "Baby & Kids", "baby", null, ["grandprice"]],
  ["toys-games", "Toys & Games", "puzzle-piece", null, ["grandprice"]],
  ["books-media", "Books & Media", "book", null, ["grandprice"]],
  ["automotive", "Automotive", "car", null, ["grandprice"]],
  // Tizzi Gas — LPG tree
