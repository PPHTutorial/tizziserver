  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            const AppScreenHeader('My tickets'),
            Expanded(
              child: wallets.when(
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          TextButton(
                            onPressed: () => context.go(RoutePaths.auctions),
                            child: const Text('Browse draws'),
                          ),
                        ],
                      ),
                    );
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return AppCard(
                        padding: const EdgeInsets.all(AppSpace.s16),
                        onTap: () =>
                            context.push(RoutePaths.auction(w.auctionSlug)),
                        child: Row(
                          children: [
                            Container(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '${auctionStatusLabel(w.auctionStatus)} · ${auctionDemandLabel(w.fillPct)}',
